...
const AllFilters = (props) => {
    ...
    return(
        ...
        <div className="filters">
            <div  className="price">
                <p onClick={showPrice}> <span>Price</span> <span className={activePrice ? 'plus' : ''}>+</span> </p>   
                <div className={activePrice ? 'showContInps inputsCont' : "inputsCont"}>
                    <input type="text" value={`${props.minvalue} $`} readOnly className={activePrice ? 'showInps priceInps': "priceInps"}/>
                    <p className={activePrice ? 'showPriceDash priceDash' : "priceDash"}>______</p>
                    <input type="text" value={`${props.maxvalue} $`} readOnly className={activePrice ? 'showInps priceInps': "priceInps"}/>
                </div> 
